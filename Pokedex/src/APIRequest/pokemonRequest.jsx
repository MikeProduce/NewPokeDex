...
export const PokemonAPI = ({nums}) => {
  ...
  return (
    <div className='lg:mx-20 mx-0'>
      {data ? (
        <ul className='text-center grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-5 object-cover'>
          {data.map((pokemon) => (
            <li className='mx-auto border-2 border-black mt-5 mx-2' key={pokemon.id}>
